...
It combines a live, filterable operations dashboard with a natural-language query assistant, so a manager can monitor workforce health at a glance and then dig into specifics by asking plain-English questions instead of writing SQL.
...
These definitions are used consistently across the dashboard and NL assistant:
...
* No forecasting
* No attrition-prediction models
* No RAG/vector databases
* No multi-agent orchestration
* No infrastructure beyond SQLite + Streamlit

Operational alerts use **transparent, adjustable thresholds** rather than machine learning.
